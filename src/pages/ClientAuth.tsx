    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {isSignUp ? "Join as Job Seeker" : "Welcome Back"}
          </h1>
          <p
            style={{
              color: colors.textSecondary,
          ...
          >
            {isSignUp
              ? "Create your account to start finding mentors"
        ...
        >
          ...
          <motion.button
            ...
            whileHover={!isLoading ? { backgroundColor: colors.secondary } : {}}
